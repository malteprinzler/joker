...
class NeRFVolumeRenderer(VolumeRenderer):
    ...
    def forward(
        ...
        light_positions: Optional[Float[Tensor, "B 3"]] = None,
        ...
        **kwargs
        ...
        light_positions_flatten: Float[Tensor, "Nr 3"] = (
            ...
            .reshape(-1, 3)
        ) if light_positions is not None else None
        ...
        t_origins = rays_o_flatten[ray_indices]
        t_dirs = rays_d_flatten[ray_indices]
        t_light_positions = light_positions_flatten[ray_indices] if light_positions is not None else None
        t_positions = (t_starts + t_ends) / 2.0
        positions = t_origins + t_dirs * t_positions
