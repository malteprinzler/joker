...
class BaseSystem(pl.LightningModule, Updateable, SaverMixin):
    ...
    def __init__(self, cfg, resumed=False, save_dir=None) -> None:
        super().__init__()
        self.cfg = parse_structured(self.Config, cfg)
        self._save_dir: Optional[str] = save_dir
    ...
    def on_train_start(self) -> None:
        # update train dataset resolution before training starts (necessary if resuming from checkpoint)
        update_if_possible(self.trainer.train_dataloader.dataset, self.true_current_epoch, self.true_global_step)
